...
HOST = "tsshack"
ROWS = [
    ("Now",        "Building zarrinpcshop.com + fusiontabriz.ir · Full-Stack projects · AI · Security"),
    ("Role",       "Computer Engineer · Full-Stack Developer · Security & Systems Enthusiast"),
    ("Stack",      "Node.js · Next.js · TypeScript · JavaScript · Python · Java · Go · C · C++ · C#"),
    ("Systems",    "Linux · Backend · APIs · Networking · ESP32 · Embedded Systems · IoT"),
    ("Focus",      "Web Applications · Security · Automation · AI · Data · System Development"),
    ("Building",   "Web platforms · Developer tools · IoT projects · Experimental systems"),
    ("Learning",   "AI · Data · Cybersecurity · Systems Programming · Embedded & Distributed Systems"),
    ("Reach",      "ehsanfazli.ir · ehsanjs.ir · @tsshack"),
]
