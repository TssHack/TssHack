"""Build the animated ASCII portrait + EHSAN wordmark identity panel.
...
def build() -> str:
    ...
    return f'''<svg xmlns="http://www.w3.org/2000/svg" width="860" height="432" viewBox="0 0 860 432" role="img" aria-label="Animated ASCII portrait and EHSAN wordmark">
<defs>
...
<text x="397" y="368" font-family="ui-monospace,Consolas,monospace" font-size="13" font-weight="700" fill="{TEXT}">EHSAN BIDKHORI</text>
